...
1. Make an [Issue](https://github.com/fakefriend24/rule-tile-variant/issues/new)
...
```json
    {
        "dependencies": {
            "com.fakefriend24.rule-tile-variant": "https://github.com/YOUR_USER/rule-tile-variant.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at no@dress.here.
